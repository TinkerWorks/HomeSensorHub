from homesensorhub.sensors.sensor_types import Humidity, Pressure, Altitude, Temperature, Gas, deadline
...
class HumidityBoschBME680(BoschBME680Type, Humidity):
    ...
    def get_sensor_value(self) -> int:
        with thread_lock:
            ...
            logger.spam("Got sensor humidity value done")
        return h
...
class PressureBoschBME680(BoschBME680Type, Pressure):
    ...
    def get_sensor_value(self) -> float:
        with thread_lock:
            ...
            logger.spam("Got sensor pressure value done")
        return p
...
class AltitudeBoschBME680(BoschBME680Type, Altitude):
    ...
    def get_sensor_value(self) -> int:
        with thread_lock:
            ...
            logger.spam("Got sensor altitude value done")
        return a
...
class TemperatureBoschBME680(BoschBME680Type, Temperature):
    ...
    def get_sensor_value(self) -> float:
        with thread_lock:
            ...
            logger.spam("Got sensor temperature value done")
        return t
...
class GasBoschBME680(BoschBME680Type, Gas):
    ...
    def get_sensor_value(self) -> float:
        with thread_lock:
            ...
            g = self._sensor.gas
            logger.spam("Got sensor gas value done")
        return g
